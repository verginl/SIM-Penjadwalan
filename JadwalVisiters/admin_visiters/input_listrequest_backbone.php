...
<tr>
      <td>Sub Area</td>
      <td>:</td>
      <td><input name="sub_area" type="text" required class="form-control" id="sub_area" placeholder="Masukkan Detail Network troubles (ex : Pluit ONB 3)" value="<?php echo @$edit['sub_area'] ?>"></td>
</tr>
<tr>
      <td>Subjek Email</td>
      <td>:</td>
...
<tr>
      ...
      <td>:</td>
      <td>
<textarea name="note" type="text" class="form-control" id="note" placeholder="Masukkan Personal Note" value=""><?php echo @$edit['note'] ?></textarea>
