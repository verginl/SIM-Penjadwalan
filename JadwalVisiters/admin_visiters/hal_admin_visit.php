...
$perintah=new crud();
$perintah->koneksi();
@$perintah->tampil("tbl_admin_visiters WHERE username='$_SESSION[username]'");
@$tampil=mysql_fetch_array(mysql_query("SELECT *FROM tbl_admin_visiters where username='$_SESSION[username]'"));
 ...
 <link href="../../css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="?menu=absen_karyawan"><i class="fa fa-edit fa-fw"></i> Absen Karyawan</a>
                        </li>
                         <li>
                         ...
                         <li>
                            ...
                            <li>
                            <a href="#"><i class="fa fa-file-pdf-o fa-fw"></i> Data Report<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><a href="?menu=drc">Report Single</a></li>
                                 <li><a href="?menu=drb">Report Multiple</a></li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
  ...
  <?php
                    switch (@$_GET['menu']){
                        ...
                        break;
						    case "src";
                        include "send_request_costumer.php" ;
                        break;	
                        case "srb";
                        include "send_request_backbone.php" ;
                        break;
					...
					break;
					case"drc";
				include"data_report_ts.php";
				break;
				case"drb";
				include"data_report_backbone.php";
				break;
				
					case "rc";
                        include "return_costumer.php" ;
                        break;
						case "hc";
                        include "histori_costumer.php" ;
                        break;
						case "rb";
                        include "return_backbone.php" ;
                        break;
				...
				break;
				case"ertb";
				include"edit_report_backbone.php";
				break;
				case"contact";
				include"copyright.php";
				break;
				case"dtbssssss";
				include"data_troubleshot.php";
				break;
                    }
                        ?>
<br>
...
<h5 style="color:#428BCA;padding-top:15px;" align="center"><a href="?menu=contact"> &copy; 2017 : Technical Support. All Right Reserved.</a></h5>
    <!-- /#wrapper -->
