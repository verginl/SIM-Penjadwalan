...
<thead>
    		<tr style="background-color:#95a5a6;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Preventive Maintenance</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '1'");
					$no = 1;
...
<thead>
    		<tr style="background-color:#34495e; color:#FFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Hold</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '2'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<td><?php echo $row['id_tiketbackbone']?> </td>    
<td><?php echo $row['note']?> </td>   
<td width="100" align="center"> <a href="?menu=srb&edit&id=<?php echo @$row['id_tiketbackbone'] ?>">Go</a></td></tr>
<?php  $no++;  }
					?>
		</div><!-- /.box-body -->
        </div>	
...
<thead>
    		<tr style="background-color:#e67e22;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Pending FFTH</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '3'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<tr style="background-color:#e74c3c;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Serang</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '4'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr style="color:#FFF; background-color:#16a085">
        		<Th   colspan="11"><center>List Troubleshoot Area Tanggerang</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '5'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr style="color:#FFF; background-color:#2E2E2E">
        		<Th   colspan="11"><center>List Troubleshoot Area Bekasi</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '6'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr style="color:#FFF; background-color:#27ae60">
        		<Th   colspan="11"><center>List Troubleshoot Area Bogor</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '7'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr style="color:#FFF; background-color:#34495e">
        		<Th   colspan="11"><center>List Troubleshoot Area Depok</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '8'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr  style="background-color:#95a5a6;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Jakarta Utara</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '9'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr  style="background-color:#34495e;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Jakarta Pusat</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '10'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr  style="background-color:#95a5a6;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Jakarta Selatan</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '11'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr style="background-color:#34495e;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Jakarta Barat</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '12'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr  style="background-color:#95a5a6;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Mid Dan Sekitarnya</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '13'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<thead>
    		<tr style="background-color:#34495e;color:#FFFFFF;">
        		<Th   colspan="11"><center>List Troubleshoot Area Priority Costumer</center></Th>
        	</tr>
<tr>
<th>No</th>
<th>Sub Email</th>
...
<th>Action</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_list_backbone where id_area = '14'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
