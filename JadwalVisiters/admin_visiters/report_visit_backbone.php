...
<tr>
      <td>ID Karyawan</td>
      <td>:</td>
      <td><input name="id_karyawan" type="text" readonly required class="form-control" id="id_karyawan" placeholder="ID Karyawan"   value="<?php echo @$edit['id_karyawan'] ?>" ></td>
</tr>
<tr>
      <td>Action</td>
      <td>:</td>
