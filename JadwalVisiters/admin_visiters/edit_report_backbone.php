...
Report Visit $_POST[sub_area] - $_POST[tgl_visit] - Revised
</th>
</font>
</tr>
...
<thead>
  ...
  <tbody>
    <tr>
      <td>ID Report</td>
      <td>:</td>
      <td><input type="text" readonly class="form-control" placeholder="ID Harus Sesuai" name="id_report" value="<?php echo @$edit['id_report'] ?>"></td>
</tr>
...
<tr>
      ...
      <td>:</td>
      <td>
<textarea name="action" class="form-control" id="action" placeholder="Masukkan Action" ><?php echo @$edit['action'] ?></textarea>
...
<tr>
<td>Nama TS & Partner</td>
<td>:</td>
<td><div class="col-md-5"><input type="text" name="nama_ts" placeholder="Nama TS" required class="form-control" value="<?php echo @$edit['nama_karyawan'] ?>" readonly></div> <h5 style="float:left"> & </h5> <div class="col-md-5"><input type="text" name="nama_partner" placeholder="Partner Visit TS" readonly value="<?php echo @$edit['nama_partner']?>" class="form-control"></div> </td>
</tr>
...
<?php }else{?>
<input class="btn btn-success" type="submit"  name="ubah" value="Update Report"> </td>
<?php }?></td>
</td>
</tr>
