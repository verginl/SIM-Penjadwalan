...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '1'");
					$no = 1;
...
<td width="100" align="center"> <a href="?menu=rc&edit1&id=<?php echo $row['id_tiketrequestvisit'] ?>">Return</a></td></tr>
<?php  $no++;  }
					?>
		</div><!-- /.box-body -->
        </div>	
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '2'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '3'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '4'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
						
                        ?>
<tr style="background-color:#e74c3c;color:#FFFFFF;"><td><?php echo $no?> </td>
<td><?php echo $no?> </td>
<td><?php echo $row['no_tiket'] ?></td>
<td><?php echo $row['nama_pelanggan'] ?></td>
<td><?php echo $row['alamat'] ?></td>
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '5'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '6'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '7'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '8'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '9'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '10'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '11'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '12'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '13'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_send_costumer where id_area = '14'");
					$no = 1;
                    while ($row = mysql_fetch_array($result)) {
