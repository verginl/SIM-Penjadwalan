...
@$where2="id_report=$_GET[id2]";
$link="?menu=report_visit_ts";
@$tgl=date('Y-m-d');
...
$subject='Report Visit '. $_POST['nama_pelanggan'].'  - TiketID : '. $_POST['no_tiket'].'';
...
Report Visit $_POST[nama_pelanggan] - TiketID : $_POST[no_tiket]
</th>
</font>
</tr>
...
if(isset($_GET['edit1'])){
	@$edit=$perintah->edit($query2,$where2);	
}
...
<tr>
      <td>No Tiket</td>
      <td>:</td>
      <td><input name="no_tiket" type="text"  readonly required  class="form-control" id="no_tiket" placeholder="Nomor Tiket Harus Sesuai" value="<?php echo @$edit['no_tiket'] ?>"></td>
</tr>
<tr>
      <td>Nama Costumer</td>
      <td>:</td>
      <td><input type="text" class="form-control" required  readonly  placeholder="Nama Costumer Harus Sesuai" name="nama_pelanggan" value="<?php echo @$edit['nama_pelanggan'] ?>"></td>
</tr>

<tr>
      <td>Alamat</td>
      <td>:</td>
      <td><textarea name="alamat" required readonly class="form-control" id="alamat"><?php echo @$edit['alamat'] ?></textarea>
...
<tr>
      ...
      <option>Pilih Replace Adaptor</option>
...
<tr>
      ...
      <td><select name="charge" class="form-control" required >
        ...
        <option value="<?php echo @$value ['charge'] ?>"> <?php echo @$edit ['charge']?> </option>
    <?php 
...
<?php }else if(@$_GET['id2']==1){?>
<input class="btn btn-success" type="submit"  name="ubah" value="Update Report">

<?php }else{ ?>
<input class="btn btn-success" type="submit"  name="simpan" value="Send Report"> 
<?php } ?>
