...
@$tampil=mysql_fetch_array(mysql_query("SELECT *FROM qw_report_ts where username='$_SESSION[username]'"));
...
<thead>
<tr>
        		<Th   colspan="22"><center>Data Report Single Costumer <?php echo $tampil['nama_karyawan'] ?></center></Th>
        	</tr>
<tr class="tr">
<th>No</th>
<th>Nomer Tiket</th>
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("select * from qw_report_ts where username = '$_SESSION[username]'");
					$no = 1;
...
<?php  $no++;  }
					?>
                   <tfoot>
                    <tr><td colspan="22" align="right"><a href="export_costumer.php?menu=edc&idk=<?php echo @$tampil['id_karyawan']  ?>">Export Report</a></td></tr>
                    </tfoot>
		</div><!-- /.box-body -->
        </div>	
</table>
