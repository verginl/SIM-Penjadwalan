...
@$tampil=mysql_fetch_array(mysql_query("SELECT *FROM qw_absen"));

@$field=array('id_karyawan'=>$_POST['id_karyawan'],'nama_karyawan'=>$_POST['nama_karyawan'],'jadwal_masuk'=>$_POST['jadwal_masuk'],'tgl_absen'=>$_POST['tgl_absen']);
...
<th>Tanggal Absen</th>                        
                    ...
                    <?php
					$result = mysql_query("SELECT * FROM qw_absen");
					$no = 1;
