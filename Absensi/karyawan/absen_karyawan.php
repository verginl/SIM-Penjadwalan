...
<th colspan="3"><center><h4>Absen Karyawan Tanggal : <?php echo $tgl ?></h4></center></th>
  ...
  <tbody>
    <tr>
      <td>ID Karyawan</td>
      <td>:</td>
      <td><input name="id_karyawan" type="text" readonly="readonly"  class="form-control" id="id_karyawan" placeholder="Id Karyawan" value="<?php echo @$tampil['id_karyawan'] ?>"></td>
</tr>
    <tr>
      <td>Nama Lengkap</td>
      <td>:</td>
      <td><input name="nama_karyawan" type="text" readonly="readonly"  class="form-control" id="nama_karyawan" placeholder="Masukkan Nama" value="<?php echo @$tampil['nama_karyawan'] ?>"></td>
</tr>
...
<th>Jam Absen</th>
                    ...
                    <?php
					$result = mysql_query("select * from qw_absen where username = '$_SESSION[username]'");
					$no = 1;
