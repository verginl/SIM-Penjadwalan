            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?menu=data_diri"><i class="fa fa-user fa-fw"></i> Data Diri Karyawan</a>
                        </li>
                         <li>
                            <a href="?menu=data_absen"><i class="fa fa-list-alt fa-fw"></i> Data Absen</a>
                        </li>
                        <li>
                      ...
                      <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li><a href="?menu=data_report_ts">Report Single</a></li>
                                 <li><a href="?menu=data_report_backbone">Report Multiple</a></li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
 <li>
...
<?php
			switch (@$_GET['menu']){
				...
				break;
				case"data_report_backbone";
				include"data_report_backbone.php";
				break;
				
				case"erts";
				include"edit_report_ts.php";
				break;
				case"ertb";
				include"edit_report_backbone.php";
				break;
				case"edb";
	   			include"export_backbone.php";
	  			break;
	   			case"edc";
	   			include"export_costumer.php";
	   			break;
	   			case"contact";
