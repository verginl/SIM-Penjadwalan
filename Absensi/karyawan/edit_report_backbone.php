...
$subject='Report Visit - Tiket ID : '. $_POST['id_tiketbackbone'].'';
...
Report Visit Backbone $_POST[subjek_email] - TiketID : $_POST[no_tiket] - Revised
</th>
</font>
</tr>
...
<tr BGCOLOR=#EE5C2D>
<th colspan=2><font size=5>
Report Visit Backbone $_POST[subjek_email] - TiketID : $_POST[id_tiketbackbone] - Revised
</th>
</font>
</tr>
...
<td>Nama Partner</td>
<td>:</td>
<td><input type="text" name="nama_partner" placeholder="Partner Visit TS" required class="form-control" value="<?php echo @$edit ['nama_partner'] ?>"> </td>
</tr>
