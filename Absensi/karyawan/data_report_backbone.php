...
@$tampil=mysql_fetch_array(mysql_query("SELECT *FROM qw_report_backbone where username='$_SESSION[username]'"));
?>
<!doctype html>
<html>
<head>
...
<th>Aksi</th>
                    ...
                    <?php
					$result = mysql_query("select * from qw_report_backbone where username = '$_SESSION[username]'");
					$no = 1;
...
<?php  $no++;  }
					?>
                    <tfoot>
                    <tr><td colspan="12" align="right"><a href="export_backbone.php?menu=edb&idk=<?php echo @$tampil['id_karyawan']  ?>">Export Report</a></td></tr>
                    </tfoot>
		</div><!-- /.box-body -->
        </div>	
</table>
